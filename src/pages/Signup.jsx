        ...
        <div className='w-full min-h-screen flex items-center justify-between gap-12 px-9 pt-28 pb-8 flex-wrap'>
            ...
            <form action="" className='bg-accent text-slate-200 p-5 rounded-xl w-1/3'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type="password" placeholder='confirm password' className='p-2 text-accent outline-none border-2 rounded-lg w-full' />
                </div>
                <button className='my-6 bg-slate-200 text-accent font-semibold py-2 w-full rounded-md border-none hover:bg-slate-300'>Sign-Up</button>
